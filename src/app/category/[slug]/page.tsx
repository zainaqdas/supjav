...
async function getCategoryVideos(slug: string, page: number, sort?: string): Promise<{ videos: VideoResult[]; totalPages: number; page: number; totalResults: number; name?: string }> {
  try {
